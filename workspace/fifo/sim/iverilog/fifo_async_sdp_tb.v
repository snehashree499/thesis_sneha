...
module tb;
	...
	initial begin
`ifdef CCSDF
		$sdf_annotate("fifo_async_sdp_00.sdf", dut);
`endif
		$dumpfile("sim/fifo_async_sdp_tb.vcd");
		$dumpvars(0, tb);
		POP_CLK     = 0;
		PUSH_CLK    = 0;
		POP_EN      = 0;
	...
	always POP_CLK = #2 ~POP_CLK;
	always PUSH_CLK = #1 ~PUSH_CLK;
	...
	initial begin
		...
		F_RST_N = ~F_RST_N;
		#10;
		$write("Push data with slow clock\n");
		PUSH_EN = 1;
		#10;
		PUSH_WE = 1;
		...
		$write("\nPop data with fast clock, no pushing\n");
		POP_EN = 1; PUSH_WE = 0;
